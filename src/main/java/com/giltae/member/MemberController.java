...
public class MemberController {
	...
	public ModelAndView memberPost(@RequestParam Map<String, Object> map, HttpServletResponse response)
			throws Exception {
...
//	// 마이페이지 끝
	...
	public ModelAndView memberModPost(@RequestParam Map<String, Object> map, HttpServletResponse response,
