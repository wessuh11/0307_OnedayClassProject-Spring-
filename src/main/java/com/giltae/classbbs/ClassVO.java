...
public class ClassVO {
	// 낙타(카멜)표기법 : 의미가 달라지면 대문자를 쓴다.
	// lombok : 게터와 세터 자동생성 + toString() 생성 이것을 자동으로 해줌
	...
	public String toString() {
		return "BoardVO [cNum=" + cNum + ", cCode=" + cCode + ", cTeacher=" + cTeacher + ", cUid=" + cUid
				+ ", cCategory=" + cCategory + ", cTitle=" + cTitle + ", cContent=" + cContent + ", cRegDate="
				+ cRegDate + ", cPrice=" + cPrice + ", cDelivery=" + cDelivery + ", cThumbName=" + cThumbName
				+ ", cThumbSize=" + cThumbSize + ", cFileName=" + cFileName + ", cFileSize=" + cFileSize + ", cMaxStu="
				+ cMaxStu + ", cApplyStu=" + cApplyStu + ", cArea=" + cArea + ", cOnoff=" + cOnoff + ", cStatus="
				+ cStatus + ", cLikes=" + cLikes + "]";
	}
