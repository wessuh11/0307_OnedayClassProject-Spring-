                ...
                <c:choose>
                    ...
                    <li id="mainLi3" class="mainLi" >           
                        ...
                        <div id="subMenu3" class="subContainer">
                            ...
                            <c:choose>
                    			<c:when test="${uLevel eq '1'}">
                                <li class="subMenuLi"><a href="/Member_Mod.jsp" id="memModBtn">회원 정보 수정</a></li>
                                <li class="subMenuLi"><a href="/LvlUpPost.jsp" id="">등업 신청</a></li>
