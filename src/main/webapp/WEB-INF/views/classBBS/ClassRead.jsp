         ...
         <div id="details" class="flex-container">       
        	...
        	<div id="thumbinfo">
        		...
        		<table>
                    ...
                    <td>
                       <button type="button" class="buy" id="buy" onClick="location.href='../payment/CartAction.jsp?cNum=<%= cNum %>&uId=<%=uId%>&nowPage=<%=nowPage%>'">클래스 담기</button>
                    </td>
                    <td>
                       <button type="button" class="put" id="put" onClick="location.href='../payment/Cart.jsp'">결제</button>
                    </td>
                    <!-- 결제페이지 이동 -->
        			</tr>
        		</table>
